 ...
 * 通告处理
 */
public class AnnunciateOrderAdapter extends BaseAdapter {

    private Context mContext;
    private List<AnnuciteFragmentBean.DataBean> mList;
    public AnnunciateOrderAdapter(Context context, List<AnnuciteFragmentBean.DataBean> list) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = LayoutInflater.from(mContext).inflate(R.layout.item_annunciate_order, null);
            view.setTag(holder);
