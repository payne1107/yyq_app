...
public class MainActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void resetButton() {
        Drawable drawable1 = getResources().getDrawable(R.mipmap.tabbar_home);
        Drawable drawable2 = getResources().getDrawable(R.mipmap.tabbar_hostory);
        Drawable drawable3 = getResources().getDrawable(R.mipmap.tabbar_message);
        Drawable drawable4 = getResources().getDrawable(R.mipmap.tabbar_usercenter);
        drawable1.setBounds(0, 0, drawable1.getMinimumWidth(), drawable1.getMinimumHeight());
        drawable2.setBounds(0, 0, drawable2.getMinimumWidth(), drawable2.getMinimumHeight());
        drawable3.setBounds(0, 0, drawable3.getMinimumWidth(), drawable3.getMinimumHeight());
